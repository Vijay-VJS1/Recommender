...
##################
movies_df=pd.read_feather("/content/drive/MyDrive/Movies/movie_deploy.feather")#movies_df=pd.read_feather("/content/drive/MyDrive/Movies/stream_tmdb_full_data1.feather")
df=movies_df.copy()
movies_list=df['title'].values
movies_list=np.append(movies_list,"")
movies_list=sorted(movies_list)
similarity1=pd.read_feather('/content/drive/MyDrive/Movies/similarity1.feather')
similarity2=pd.read_feather('/content/drive/MyDrive/Movies/similarity2.feather')
######################
